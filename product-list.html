    ...
    <div>
      ...
      <div class="product-list-container">
        ...
        <div class="product-list-container2">
          <a href="product-detail.html" class="product-list-navlink">
            <div class="product-list-product-container">
              <img
                src=""
                alt="image"
                class="product-list-image1"
              />
              <span class="product-list-text3">Product</span>
            </div>
          </a>
          <a href="product-detail.html" class="product-list-navlink1">
            <div class="product-list-product-container1">
              <img
                src=""
                alt="image"
                class="product-list-image2"
              />
              <span class="product-list-text4">Product</span>
            </div>
          </a>
          <a href="product-detail.html" class="product-list-navlink2">
            <div class="product-list-product-container2">
              <img
                src=""
                alt="image"
                class="product-list-image3"
              />
              <span class="product-list-text5">Product</span>
            </div>
          </a>
        </div>
      </div>
